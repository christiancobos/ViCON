...
set_property PACKAGE_PIN J3 [get_ports RSTn]
set_property IOSTANDARD LVCMOS33 [get_ports RSTn]


## Configuración de señales de datos de MT9V111
set_property PACKAGE_PIN K2 [get_ports {CAMERA[7]}]
set_property IOSTANDARD LVCMOS33 [get_ports CAMERA[7]]
set_property PACKAGE_PIN J1 [get_ports {CAMERA[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports CAMERA[6]]
set_property PACKAGE_PIN N1 [get_ports {CAMERA[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports CAMERA[5]]
set_property PACKAGE_PIN N2 [get_ports {CAMERA[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports CAMERA[4]]
set_property PACKAGE_PIN M1 [get_ports {CAMERA[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports CAMERA[3]]
set_property PACKAGE_PIN M2 [get_ports {CAMERA[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports CAMERA[2]]
set_property PACKAGE_PIN M3 [get_ports {CAMERA[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports CAMERA[1]]
set_property PACKAGE_PIN L3 [get_ports {CAMERA[0]}]
